...
df_result_Status_count = spark.sql(f"""select count(1) from {Catalog_Name_L2}.qnr.l1_audit_dq_monitoring_log where Run_date = '{LastLoadedDate}' and ExtractionType = 'L1 Data Load'""").collect()[0][0]
