...
pd_Max_Value=spark.sql("select DQ_ID from {0}.qnr.l2_audit_dq_monitoring_rules where Source_Name = '{1}' order by DQ_ID".format(Catalog_Name_L2,Source_Name)).toPandas()['DQ_ID']
