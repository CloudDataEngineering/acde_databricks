...
DESCRIBE DATABASE hive_metastore.demo; 

-- COMMAND ----------

DESCRIBE DATABASE EXTENDED hive_metastore.demo; 

-- COMMAND ----------

-- drop database if exists hive_metastore.demo;
...
SHOW TABLES IN hive_metastore.demo;
