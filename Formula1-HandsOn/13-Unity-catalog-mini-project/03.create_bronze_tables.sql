...
-- MAGIC Bronze folder path - abfss://bronze@databricksadlsext.dfs.core.windows.net
...
USING json
OPTIONS (path "abfss://bronze@databricksadlsext.dfs.core.windows.net/drivers.json");
...
USING json
OPTIONS (path "abfss://bronze@databricksadlsext.dfs.core.windows.net/results.json");
