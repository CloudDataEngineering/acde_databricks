...
results_final_df = lap_times_df.withColumnRenamed("raceId", "race_id").\
...
# results_final_df.write.mode('overwrite').parquet('/mnt/adlsacde/processed/laptimes')

# results_final_df.write.mode('overwrite').format('parquet').saveAsTable('hive_metastore.f1_processed.laptimes')
...
overwrite_partition(results_final_df, 'hive_metastore', 'f1_processed', 'laptimes', 'race_id')
