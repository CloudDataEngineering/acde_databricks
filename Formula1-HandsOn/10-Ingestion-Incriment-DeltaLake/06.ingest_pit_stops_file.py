...
# overwrite_partition(final_df, 'hive_metastore', 'f1_processed', 'pitstops', 'race_id')
...
merge_delta_data(final_df, 'hive_metastore', 'f1_processed', 'pitstops', processed_folder_path, merge_condition, 'race_id')
