...
# DBTITLE 1,Writing parquet file for final circuits dataframe.
# circuits_final_df.write.mode('overwrite').parquet(f'{processed_folder_path}/circuits')

# COMMAND ----------

# DBTITLE 1,Writing Circuits Data to Hive Metastore as Parquet
# circuits_final_df.write.mode('overwrite').format('parquet').saveAsTable('hive_metastore.f1_processed.circuits')

# COMMAND ----------

# DBTITLE 1,Write Circuits Data to Delta Table
