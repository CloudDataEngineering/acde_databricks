...
# DBTITLE 1,Overwrite Partition Function Call
# overwrite_partition(results_final_df, 'hive_metastore', 'f1_processed', 'results', 'race_id')

# COMMAND ----------

# DBTITLE 1,Merge Delta Data Using UDF
merge_condition = "tgt.result_id = src.result_id and tgt.race_id = src.race_id"
# merge_delta_data(input_df, schema_name, db_name, table_name, folder_path, merge_condition, partition_column)
merge_delta_data(result_deduped_df, 'hive_metastore', 'f1_processed', 'results', processed_folder_path, merge_condition,  'race_id')
