...
merge_delta_data(final_df, 'hive_metastore', 'f1_presentation', 'race_results', presentation_folder_path, merge_condition,  'race_id')
...
# MAGIC race_id, count(*)
# MAGIC from 
# MAGIC hive_metastore.f1_presentation.race_results 
# MAGIC group by all
