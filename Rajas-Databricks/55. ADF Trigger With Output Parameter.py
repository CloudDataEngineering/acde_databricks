...
# DBTITLE 1,Setup Input Parameter
dbutils.widgets.text('table', '')

# COMMAND ----------

# DBTITLE 1,Get Input Parameter Into Variable
...
sales_address = spark.read.format('jdbc').option('url', jdbcUrl).option('dbtable',tableName).load() #SalesLT.Address
...
# DBTITLE 1,Output Patameter
dbutils.notebook.exit(outPath)
