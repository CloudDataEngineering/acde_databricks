...
# MAGIC %md
# MAGIC ## Soluction Without Secreats Scope
...
dbutils.fs.mount(
    source = 'wasbs://demo@adlsvinay2907.blob.core.windows.net/',
    mount_point = '/mnt/demo',
    extra_configs = 
    {'fs.azure.account.key.adlsvinay2907.blob.core.windows.net':'Account_key'}
)
...
# MAGIC %md
# MAGIC ##Soluction With Secreats Scope
# MAGIC
# MAGIC ###https://<Databricks-name>.azuredatabricks.net/?o=1249978625340872#secrets/createScope

# COMMAND ----------

# DBTITLE 1,List down the secret Scopes
...
dbutils.fs.unmount('/mnt/adf-demo')
